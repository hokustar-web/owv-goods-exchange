...
const CROWN_LOGO = "data:image/png;base64,";
...
const CATALOG_SERIES = [
  ...
  { name: "STRANGE", from: 52, to: 56, extras: ["R-001"] },
  { name: "Let Go", from: 57, to: 62 },
  { name: "CASINO", from: 63, to: 73, extras: ["R-002", "R-003"] },
  { name: "JACK POT", from: 74, to: 79, extras: ["R-004"] },
  { name: "MUSEUM", from: 84, to: 91, unofficial: true },
  { name: "BREMEN", from: 92, to: 97, unofficial: true },
  { name: "LOVE BANDITZ", from: 98, to: 103, unofficial: true },
  { name: "Frontier", from: 104, to: 109, unofficial: true },
  { name: "王舞祭", from: 110, to: 115, unofficial: true },
  { name: "VERSUS", from: 116, to: 121, unofficial: true },
  { name: "Supernova", from: 122, to: 127, unofficial: true },
  { name: "BLACK CROWN", from: 128, to: 133, unofficial: true },
  { name: "TWO THRONE", from: 134, to: 137, unofficial: true },
  { name: "ROCKET MODE", from: 138, to: 143, unofficial: true },
  { name: "SQUAD", from: 144, to: 149, unofficial: true },
];
// (individual RARE cards were folded into their original series: R-001 → STRANGE,
// R-002/R-003 → CASINO, R-004 → JACK POT, R-005 → MUSEUM as a renumbered card)
...
const CATALOG_SERIES_GROUP = [
  ...
  { name: "MUSEUM", from: 77, to: 85, unofficial: true },
  { name: "BREMEN", from: 86, to: 93, unofficial: true },
  { name: "LOVE BANDITZ", from: 94, to: 101, unofficial: true },
  { name: "Frontier", from: 102, to: 109, unofficial: true },
  { name: "王舞祭", from: 110, to: 117, unofficial: true },
  { name: "VERSUS", from: 118, to: 125, unofficial: true },
  { name: "Supernova", from: 126, to: 135, unofficial: true },
  { name: "BLACK CROWN", from: 136, to: 143, unofficial: true },
  { name: "TWO THRONE", from: 144, to: 150, unofficial: true },
  { name: "ROCKET MODE", from: 151, to: 158, unofficial: true },
  { name: "SQUAD", from: 159, to: 166, unofficial: true },
];

// (group RARE R-005 was folded into MUSEUM as renumbered card 085)
...
function buildCatalogOptionsFor(seriesList, rare) {
  ...
  seriesList.forEach((s) => {
    ...
    (s.extras || []).forEach((num) => {
      options.push({ seriesName: s.name, number: num, unofficial: !!s.unofficial });
    });
  });
  if (rare) {
...
const CATALOG_OPTIONS = buildCatalogOptionsFor(CATALOG_SERIES, null);
const CATALOG_SERIES_NAMES = CATALOG_SERIES.map((s) => s.name);

const CATALOG_OPTIONS_GROUP = buildCatalogOptionsFor(CATALOG_SERIES_GROUP, null);
const CATALOG_SERIES_NAMES_GROUP = CATALOG_SERIES_GROUP.map((s) => s.name);
...
// pair/member names for 集合ペア cards in the unofficial (MUSEUM onward) series.
// position within each series determines the name; TWO THRONE has its own list.
const GROUP_PAIR_NAMES = ["本田中川", "本田浦野", "本田佐野", "中川浦野", "中川佐野", "浦野佐野", "集合①", "集合②", "集合③", "集合④"];
const GROUP_TWO_THRONE_NAMES = ["本田海帆西島", "中川高橋太田", "浦野古瀬四谷", "佐野小堀栗田", "集合①", "集合②", "集合③"];

// member-aware label: for 集合ペア unofficial series returns e.g. "本田中川(077)",
// otherwise falls back to the plain (number) format
function formatCatalogLabel(memberName, seriesName, number) {
  if (memberName === "集合ペア") {
    const s = CATALOG_SERIES_GROUP.find((x) => x.name === seriesName && x.unofficial);
    const n = parseInt(number, 10);
    if (s && !Number.isNaN(n) && n >= s.from && n <= s.to) {
      const names = seriesName === "TWO THRONE" ? GROUP_TWO_THRONE_NAMES : GROUP_PAIR_NAMES;
      const name = names[n - s.from];
      if (name) return `${name}(${number})`;
    }
  }
  return formatCatalogNumber(seriesName, number);
}
...
async function renderImage(canvas, { mode, cards, profileName, layout = "detail" }) {
  ...
  // paint() draws the full image at canvas height H and reports how far the
  // content actually reached, letting us shrink the canvas to fit short lists
  const paint = (H) => {
  const ctx = canvas.getContext("2d");
  ...
  ctx.fillStyle = "#ffffff";
  roundRect(ctx, margin, margin, CANVAS_W - margin * 2, H - margin * 2, 28);
  ctx.fill();
  ctx.restore();
  ...
  const contentBottom = cards.length === 0 ? y + 90 : y - 24;
  ...
  return { overflowed, contentBottom };
  };

  // measure at max height first, then re-render at a height that just fits
  // the content (capped at CANVAS_H) so short lists produce shorter images
  canvas.width = CANVAS_W;
  canvas.height = CANVAS_H;
  let result = paint(CANVAS_H);
  const desiredH = Math.max(720, Math.min(CANVAS_H, Math.round(result.contentBottom) + 148));
  if (desiredH < CANVAS_H) {
    canvas.height = desiredH; // resizing clears the canvas
    result = paint(desiredH);
  }
  return { overflowed: result.overflowed };
}
...
export default function App() {
  ...
  const [, setImagesVersion] = useState(0); // bumped when owv-images.json is hot-swapped

  // --- data & code freshness ---
  // owv-images.json: fetched with revalidation; the ETag lets us detect a
  // replaced file (e.g. new cards) and swap it in WITHOUT reloading the page.
  // index.html: only changes when the app code itself changes; in that case
  // we reload to pick up the new bundle.
  useEffect(() => {
    let imagesEtag = null;
    let initialHtml = null;

    const loadImages = () =>
      fetch("/owv-images.json", { cache: "no-cache" })
        .then((r) => {
          if (!r.ok) throw new Error(String(r.status));
          const etag = r.headers.get("etag");
          if (etag && etag === imagesEtag) return null; // unchanged
          imagesEtag = etag;
          return r.json();
        })
        .then((d) => {
    ...
    const checkForUpdate = () => {
      ...
      loadImages(); // refresh card images in place if the JSON changed
      fetchHtml().then((t) => {
        if (t && initialHtml && t !== initialHtml) {
          window.location.reload(); // app code changed
        }
      });
    };
      ...
      note: isCatalog
        ? isGoods
          ? fGoodsName
            ...
            : fGoodsItem
          : `${fCatalogSeries} ${formatCatalogLabel(fMember, fCatalogSeries, fCatalogNumber)}`
        : fNote.trim(),
      image: isCatalog
        ? isGoods
    ...
    <div className="min-h-screen pb-16" style={pageBg}>
      ...
      <div className="px-5 pt-6 pb-4">
        <div className="flex flex-col items-center gap-0.5 mb-1">
          <img src={CROWN_LOGO} alt="" className="no-save" style={{ width: "48px", height: "auto", marginBottom: "4px" }} />
      ...
      <div className="px-5 space-y-5">
        ...
        <footer className="pt-2 pb-6 text-center space-y-1">
          <p className="text-[10px] text-white">© 2026 hoku. All Rights Reserved.</p>
          <p className="text-[10px] text-white leading-relaxed">
            本アプリは個人のファン活動を目的とした非公式ツールです。個人利用のみ
            <br />
            可能です。コード・デザインの複製、再配布、改変版の公開はご遠慮ください。
          </p>
        </footer>
      </div>
                        ...
                        return (
                          <div key={o.number} className="rounded-lg overflow-hidden">
                            <div className="w-full aspect-square bg-gray-50 flex items-center justify-center overflow-hidden">
                              {thumb ? (
                                <img src={thumb} alt={o.number} className="no-save w-full h-full object-contain" />
                              ) : (
                                <ImageIcon className="w-5 h-5 text-gray-200" />
                              )}
                            </div>
                            <div className="text-[10px] font-medium py-1 text-center bg-gray-50 text-gray-500">
                              {formatCatalogLabel(galleryMember, seriesName, o.number)}
                            </div>
                          </div>
                        );
                      })}
                        ...
                        {(isOtherMember ? GOODS_ITEM_NAMES_OTHER : GOODS_ITEM_NAMES)[fGoodsItem].map((name) => {
                          ...
                          return (
                            ...
                            >
                              <div className="w-full aspect-square bg-gray-50 flex items-center justify-center overflow-hidden">
                                {thumb ? (
                                  <img src={thumb} alt={name} className="no-save w-full h-full object-contain" />
                                ) : (
                                  <ImageIcon className="w-5 h-5 text-gray-200" />
                                )}
                              </div>
                  ...
                  <>
                          ...
                          {catalogNumbersForSeries(fCatalogSeries).map((num) => {
                            ...
                            return (
                              ...
                              >
                                <div className="w-full aspect-square bg-gray-50 flex items-center justify-center overflow-hidden">
                                  {thumb ? (
                                    <img src={thumb} alt={num} className="no-save w-full h-full object-contain" />
                                  ) : (
                                    <ImageIcon className="w-5 h-5 text-gray-200" />
                                  )}
                                </div>
                                <div className={`text-[10px] font-medium py-1 ${selected ? "bg-gray-500 text-white" : "bg-gray-50 text-gray-500"}`}>
                                  {formatCatalogLabel(fMember, fCatalogSeries, num)}
                                </div>
                              </button>
                            );
                          })}
                    ...
                    {fCatalogNumber && UNOFFICIAL_CATALOG_KEYS.has(`${fCatalogSeries}|${fCatalogNumber}`) && (
                      <p className="text-[10px] text-gray-500 -mt-3 mb-4">
                        *{formatCatalogLabel(fMember, fCatalogSeries, fCatalogNumber)}は公式のナンバリングではなく、管理用の番号です。
                      </p>
                    )}
                  </>
                )}
                ...
                <div className="mb-4 flex items-center gap-3">
                  ...
                  >
                    {imgBusy ? (
                      ...
                      <img src={fImage} alt="preview" className="no-save w-full h-full object-contain" />
                    ) : (
            ...
            {cards.map((card) => (
              <div key={card.id} className="flex items-center gap-2.5 bg-white rounded-lg border border-gray-100 px-3 py-2.5">
                <div className="w-10 h-10 rounded-md bg-gray-100 shrink-0 overflow-hidden flex items-center justify-center">
                  {card.image ? (
                    <img src={card.image} alt="" className="no-save w-full h-full object-contain" />
                  ) : (
