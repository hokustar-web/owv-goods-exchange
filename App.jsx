...
export default function App() {
  ...
  // auto-update: when the app (e.g. opened from the home screen) comes back
  // into view, compare the deployed index.html against the one we started
  // with; if a new version was deployed, reload to pick it up
  useEffect(() => {
